...
제24회 임베디드SW경진대회(2026) 자유공모 부문 **개발완료보고서** 제출본과
보고서에 사용한 원본 이미지 자산을 보관하는 폴더다.
...
| `ui_lcd_1_normal_empty.jpg` ~ `ui_lcd_6_failed.jpg` | LCD 6개 상태 화면 |
| `ui_web.png` | 관리자 웹 화면 |
| `3d_*.png` | 3D 하우징 설계 렌더 (STL 원본은 `hardware/3d_models/`) |
| `thermal_spotcheck.jpg` | Thermal 현장 점검 |
| `qr_confined.png` | 게스트 대시보드 QR |
